...
//   (3) 移除废弃账号池（马良遗留）
//   (4) 日额度徽章合并到右上角 usableCreditsTop，去除重复定义
//   (5) 移除左侧重复的第二个画质档位下拉
//   (6) 从 v27.2 恢复加水印 + 去水印模块
//   (7) 统一浮窗 CSS（wm-panel/rwm-panel/help-panel/promptlib-panel 共用 .floating-panel 基类）
//   (8) 继承 kd-v2.0/v1.2：pollTask 将 status:'error' 视为终止状态，错误透传
//
// 部署目标：ai-image.lishuhang.workers.dev + gpt2.lishuhang.com
//
