// Cloudflare Worker - AI图片/视频生成器代理 v15
// v15: 真人风格用户名 + yymmdd密码后缀 + 废弃账号池 + 可用/总额度 + 登录冷却
...
function defaultState(){return{accounts:[],abandonedAccounts:[],settings:{defaultPassword:'Ml@2026Proxy',rotationStrategy:'most-credits',autoCheckin:true,autoRegister:true,theme:'system'},activeAccountIndex:-1,rotationIndex:0,lastAutoDay:'',loginCooldownUntil:0}}
