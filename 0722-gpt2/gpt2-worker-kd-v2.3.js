...
// kd-v2.3: 修复参考图上传框丢失
//   (1) onModelChange() 中 renderTopbar() 已在 v2.1 合并到 renderQuotaBadge()，
//       调用不存在的 renderTopbar() 导致 JS 报错，
//       renderRefGrid() 永远不执行，参考图 "+" 按钮不渲染
//   (2) onModelChange() 各 DOM 操作加 null guard 防御
//   (3) updateQualityTierHint() / updateGrokSizeHint() 加 null guard
//   (4) export default 改为 addEventListener（适配 service worker 格式）
//   (5) 继承 kd-v2.2 全部功能
const UPSTREAM = {
