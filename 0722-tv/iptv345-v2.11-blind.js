// 345 - live stream proxy worker · v2.11-blind
//
// Routes:
...
// v2.11: LNC adapter. Blind mapping deliberately uses only opaque numeric
// identifiers and non-display stream codes; display-name mapping exists in full only.
const LNC_DIRECTORY_URL = 'https://data.lncoperations.ee/server.json';
const LNC_ROOT = 'https://livenewschat.eu/';
const LNC_STREAMS = {
  1: 'Ymxvb21iZXJnX2xpdmU=', 2: 'Y25iY19saXZl', 3: 'Y25uaV9saXZl', 4: 'Y25udXNfbGl2ZQ==',
  5: 'ZHdfbGl2ZQ==', 6: 'ZnN0dl9saXZl', 7: 'Z2xvYmFsX2hk', 8: 'bXNuYmNpbnRsX2xpdmU=',
  9: 'bmJjbmV3c25vd19saXZl', 10: 'c2t5bmV3c19saXZl',
};
function lncStream(routeId) {
  try { return LNC_STREAMS[routeId] ? atob(LNC_STREAMS[routeId]) : ''; }
  catch (e) { return ''; }
}
...
async function fetchLncUpstream(routeId, resource, retry = true) {
  const stream = lncStream(routeId);
...
export default {
  async fetch(request, env, ctx) {
    ...
    // v2.11: /lnc<id>.m3u8 and /lncseg/<id>/<resource> (opaque numeric LNC routes)
