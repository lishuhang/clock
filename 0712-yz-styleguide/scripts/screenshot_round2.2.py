#!/usr/bin/env python3
"""Screenshot round2.2 HTML to PNG."""
import os, asyncio, glob
from playwright.async_api import async_playwright

ROUND = "/home/z/my-project/workspace-clock/0712-yz-styleguide/0811-test/round2.2"
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        for html_path in htmls:
            ...
            await page.goto("file://" + html_path, wait_until="networkidle", timeout=120000)
