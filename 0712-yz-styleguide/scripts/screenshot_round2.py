#!/usr/bin/env python3
"""Screenshot round2 1:1 HTML to PNG."""
import os, asyncio, glob
from playwright.async_api import async_playwright

ROUND = "/home/z/my-project/workspace-clock/0712-yz-styleguide/0811-test/round2"
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        for html_path in htmls:
            ...
            page = await browser.new_page(viewport={"width": 1000, "height": 1000}, device_scale_factor=2)
