...
[![图片为小云雀短剧Agent剧本助手与行业短剧剧本生产产品对比的雷达图。图中展示了自研、哔哔猩、Storyplay在7项指标上的得分情况，包括角色塑造、节奏把控、主线架构、开篇亮点、剧本内容、综合平均分和可用率。自研在5项指标中第一或并列第一，如角色塑造得2.33分，剧本内容得1.0分等。该图直观呈现了自研在各指标上的表现，与上下文提到的与行业产品对比的内容相契合。](image_1.png)](image_1.png)
...
[![从找准方向、生成剧本到微调定稿的三阶段剧本创作流程](image_2.png)](image_2.png)
...
[![故事设定](image_3.png)](image_3.png)

故事设定

[![分集大纲](image_4.png)](image_4.png)

分集大纲

[![剧本正文](image_5.png)](image_5.png)
...
[![图片展示了剧本创作界面，左侧为剧本大纲，包含猎物与执念人、猎物与执念人2、猎物与执念人3等章节，每章有对应故事背景、人物关系、情节节奏、语言风格等信息。右侧是短剧助手界面，有“生成剧本”“生成剧本草稿”“通过”“拒绝”按钮，还显示了10集剧情规划、关键人物及故事梗概等内容。图片与上下文关系紧密，直观呈现了剧本创作中大纲与助手功能的结合。](image_6.png)](image_6.png)
...
[![图片展示了小云雀短剧Agent剧本助手的创作界面。左侧为剧本大纲，包含故事背景、人物设定等信息，如“深巷巷口的少女”故事背景为夜晚，内有大雾，氛围诡异，人物有小云雀、阿月等。右侧是剧本正文，呈现了不同版本的剧本内容，如“生成分集剧本”“生成分集正文”等，每个版本有对应的时间戳及“查看修改”按钮。该图与上下文介绍的版本管理功能相契合，直观呈现了版本历史记录及查看修改操作。](image_7.png)](image_7.png)
...
[![图片展示了短剧Agent 2.0的界面，用于小说改编。界面中有“上传剧本”“AI生剧本”“自由画布”三个选项，当前选中“上传剧本”。下方有“上传小说”按钮，旁边是一个红色边框突出显示的docx图标，提示可上传参考文件进行改编。此外，还有风格库、默认比例、集数、国内剧本等设置选项，以及“立即生成”按钮。该图片与上下文介绍的将长篇小说等文本转化为适合短剧分集剧本的内容相契合，直观呈现了操作界面。](image_8.png)](image_8.png)
...
[![该图片是小云雀短剧Agent剧本助手的操作界面局部，界面左侧展示了一段剧本内容，其标题为“1. 深夜桥栏上的少女”，包含场景、人物和具体剧情内容，总累计生成3810字。界面右侧的红色框内标注了两个核心功能选项，分别为“上传文件·解析新集”和“新建一集”，该界面与文档中提及的短剧创作相关内容相匹配，用于辅助用户完成剧本的编辑与剧集的创作管理。](image_9.png)](image_9.png)
...
[![这张图片呈现了小云雀短剧Agent剧本助手的相关内容，展示了原剧本与旁白型剧本的对比示例，对应文档中关于短剧连载能力的模块。左侧为《第1集》的原剧本内容，呈现了“我”寻桃花源、遇白衣猫、黑影躲林、掏刀等叙事内容；右侧为改编后的旁白型剧本，将原剧本内容转化为适配旁白的表达，按场景分条标注人物、动作与情节，如明确人物为黑衣人等，调整叙事逻辑以适配短剧旁白及画面提示的需求，体现了改写维度中剧情提炼、叙事视角适配等能力的应用。](image_10.png)](image_10.png)
...
[![图片展示了剧本助手的界面，其中“国内剧本”选项被红色框线突出显示。在“出海剧本”选项下，有“中文底本，人物设定，台词英文...”等内容。该图片与上下文紧密相关，上下文在介绍剧本助手在出海本土化方面的功能，即让出海故事更贴近目标市场，此图直观呈现了在出海剧本生成时可选择的剧本类型，帮助用户了解可生成的出海剧本内容。](image_11.png)](image_11.png)
