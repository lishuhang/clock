...
**纳逗功能库+版本更新记录+常见问题Q&A**：[第一次用纳逗 Pro？从这里开始吧↓](/docs/getting-started)
...
![纳逗Pro-工作台-剧本环节-自动分镜](image_1.png)

**文戏重情绪**，用特写配合微弱的慢推，榨干角色眼神里的戏；**武戏重节奏**，用大幅度的镜头运动和手持呼吸感拉满现场张力。可以通过**分镜功能**提供的选项列表，快速实现镜头语言与运镜设计。

![图片展示了纳逗Pro软件中分镜功能的镜头选项列表。画面中呈现了远景、中景、近景、大特写、升、仰拍等镜头类型，以及对应的不同拍摄方式，如右摇、上摇、正扣等。该列表位于软件界面的弹窗内，背景为分镜功能界面，左侧有分镜内容显示，右侧有图片收藏夹等板块。此图与上下文紧密相关，直观呈现了分镜功能中镜头语言与运镜设计的选项，帮助创作者更好地进行镜头设计。](image_2.png)
...
![选择生图功能，选择奇智-INBP模型，打开摄影参数](image_5.png)
...
![图片展示的是纳逗Pro团队空间的“全部项目”界面。左侧有搜索栏和导航栏，可选择“全部项目”“全部资产”“个人空间”“一眼万年”“默认项目集”等。右侧显示4个项目，分别是“团队创作专项”“一眼万年活动”“一眼万年”“默认项目集”，每个项目有图标、名称、时长、文件夹数量、文件数量等信息，如“团队创作专项”有1小时拍摄、0个文件夹、16个文件等。该图与上下文介绍的团队成员可实时分拣、复制与引用，素材管理更高效等内容相关。](image_6.png)
...
![图片展示的是纳逗Pro团队数据看板界面。上方显示团队数据概览，有1个素材生成任务、81个累计生成任务、0秒累计生成时长、0个累计生成错误、团队可用算力和0%0%、累计消耗算力0%。下方有团队积分消耗趋势图、积分消耗分布饼图、成员消耗分布饼图、功能消耗分布饼图等图表，可直观呈现团队成本控制与效率量化情况，帮助制片人精准监控成本投入与成员产能，科学调配算力资源。](image_7.png)
