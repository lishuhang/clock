...
[查看堆叠节点教程 →](/zh/docs/canvas/stack-nodes)
...
[查看 Apps 使用方法 →](/zh/docs/agent/apps)
...
[查看音频生成教程 →](/zh/docs/canvas/generate-and-edit-audio)
...
[查看 Agent 对话教程 →](/zh/docs/agent/chat-with-agent)
...
[查看 TapTV 教程 →](/zh/docs/publish/publish-to-taptv)
...
[查看批量下载教程 →](/zh/docs/canvas/download-in-batches)
...
[查看视频生成教程 →](/zh/docs/canvas/generate-and-edit-video)
...
[查看生成模式教程 →](/zh/docs/agent/choose-a-generation-mode)
...
[查看团队与权限教程 →](/zh/docs/account/manage-teams-and-permissions)

## 切换和重命名画布更直接

进入画布后，点击左上角画布名称旁的箭头，可以搜索、切换或新建画布；点击画布名称即可直接重命名。点击 TapNow 标志会返回画布首页。

[查看画布管理教程 →](/zh/docs/projects/manage-canvases)
...
[查看画布入门教程 →](/zh/docs/canvas/explore-the-canvas)
...
[查看素材库教程 →](/zh/docs/canvas/use-library-and-templates)
...
[查看节点组教程 →](/zh/docs/canvas/use-library-and-templates)
...
[查看视频编辑教程 →](/zh/docs/canvas/generate-and-edit-video)
...
[查看 Seedance 2.5 教程 →](/zh/docs/canvas/generate-and-edit-video)
...
[查看 MiniMax H3 教程 →](/zh/docs/canvas/generate-and-edit-video)
...
[查看历史记录教程 →](/zh/docs/canvas/organize-your-canvas)
...
[查看主体库教程 →](/zh/docs/canvas/create-and-use-elements)
